...
const CheackOut = ({ booking }) => {
  ...
  useEffect(() => {
    fetch("https://cell-cart-server-new.onrender.com/create-payment-intent", {
      method: "POST",
  ...
  const handleSubmit = async (e) => {
    ...
    if (paymentIntent?.status === "succeeded") {
      ...
      fetch(`https://cell-cart-server-new.onrender.com/products/${productId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
      ...
      fetch(`https://cell-cart-server-new.onrender.com/orders/${_id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
